...
class InstallerPaymentDetailsScreen extends StatelessWidget {
  const InstallerPaymentDetailsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<InstallerPaymentDetailsController>();
...
class _PaymentSummary extends StatelessWidget {
  ...
  final InstallerPaymentDetailsController controller;
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 4.h),
          Text(
            'Installer payment records will appear here.',
