...
import '../../models/management_job.dart';
...
class JobDetailsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final petDoorDescription = job?.petDoorDescription.trim() ?? '';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 6.h),
          Text(
            petDoorDescription.isNotEmpty
                ? petDoorDescription
                : 'Pet door details unavailable',
            style: figtreeTextStyle(
              fontSize: 18.sp,
              fontWeight: FontWeight.w600, // SemiBold
              color: const Color(0xFF2B4554), // #2b4554
