...
class MessageListController extends GetxController {
  ...
  Future<void> loadConversations() async {
    ...
    if (authorization == null) {
      AppLoggerHelper.warning('Customer chat list: missing authorization');
      conversations.clear();
      return;
    }
    ...
    if (currentUserId == null || currentUserId.isEmpty) {
      AppLoggerHelper.warning('Customer chat list: missing current user id');
      conversations.clear();
      return;
    }
    ...
    try {
      ...
      AppLoggerHelper.error('Customer chat list load failed', error);
      conversations.clear();
    } finally {
  ...
  Future<String?> _resolveCurrentUserId(String authorization) async {
    ...
    try {
      ...
      AppLoggerHelper.warning(
        'Customer chat list user id resolve failed: $error',
      );
      return null;
    }
  }
